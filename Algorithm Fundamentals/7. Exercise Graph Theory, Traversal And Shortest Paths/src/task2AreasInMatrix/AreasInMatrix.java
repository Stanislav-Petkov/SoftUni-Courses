...
public class AreasInMatrix {
    ...
    public static class Edge {
        ...
        Edge(int sRow, int sCol) {
            this.source = new int[]{sRow, sCol}; // Source row and col
        }
    ...
    public static void main(String[] args) {
        ...
        // Zone character and the number of times it was met in a different zone
    ...
    private static void bfs(int source){
        ...
        while (!queue.isEmpty()){
            ...
            // Find the edge which does not have a new element after it
            if(edge.dest != null) {
                visitedNode[node + 1] = true;
                queue.offer(node + 1); // add the next node
            }
        }
    }
    ...
    private static void dfs(int row, int col, char areaSymbol) {
        ...
        // Build the graph, start chaining the areas
