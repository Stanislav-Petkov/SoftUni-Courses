...
public class Cinema {
    ...
    public static void main(String[] args) {
        ...
        while (!line.equals("generate")) {
            ...
            // Remove current name so that it won't be permuted
            people.remove(name);
            line = scanner.nextLine();
        }

        // After removal fewer people have remained
        combinations = new String[people.size()];
        // Save used element so that there are no repetitions of the same name
