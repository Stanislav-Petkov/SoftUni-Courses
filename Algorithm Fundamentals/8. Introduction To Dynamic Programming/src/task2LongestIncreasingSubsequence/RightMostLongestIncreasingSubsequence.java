...
public class RightMostLongestIncreasingSubsequence {
    public static void main(String[] args) {
        ...
        int maxLength = 1;
        int maxIndex = -1;
        // When I find a subsequence bigger than the previous longest subsequence, I save from where I came to it
