...
CREATE TABLE IF NOT EXISTS `peaks` (
  ...
  `mountrain_id` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `PK_Peaks` (`id`),
  KEY `fk_peaks_mountains` (`mountrain_id`),
  CONSTRAINT `fk_peaks_mountains` FOREIGN KEY (`mountrain_id`) REFERENCES `mountains` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8;


/*!40000 ALTER TABLE `peaks` DISABLE KEYS */;
INSERT INTO `peaks` (`id`, `peak_name`, `elevation`, `mountrain_id`) VALUES
	(62, 'Aconcagua', 6962, 3),
	(63, 'Botev', 2376, 4),
