...
public class ChainblockImplTest {
    ...
    private void createRandomTransactions() {
        ...
        for (int i = 2; i < 22; i++) {
            ...
            Transaction t = new TransactionImpl(i, statuses[i % statuses.length],
                    "From_" + from, "To_" + i, new Random().nextDouble() * 99.123);
    ...
    public void testChangeTransactionStatusShouldThrowIfTransactionNotPresent() {
        chainblock.changeTransactionStatus(transaction.getId(), transaction.getStatus());
    }
    ...
    @Test
    public void testGetAllSendersByStatusShouldReturnCorrectSenders() {
        fillChainblockWithTransactions();
    ...
    @Test
    public void testGetSendersWithTransactionsStatusShouldReturnMultipleDuplicatedSenders() {
        fillChainblockWithTransactions();
    ...
    @Test
    public void testGetReceiversWithTransactionsStatusShouldReturnMultipleDuplicatedReceivers() {
        fillChainblockWithTransactions();
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testGetBySenderOrderedShouldThrowWhenSenderIsNotPresent() {
        fillChainblockWithTransactions();
    ...
    public void testGetBySenderOrderShouldReturnCorrectSender() {
        ...
        for (int i = 0; i < 10; i++) {
            chainblock.add(new TransactionImpl(100 + i, TransactionStatus.SUCCESSFUL,
                    sender, "to", 1000 + 10 * i));
        }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testGetByReceiverOrderedShouldThrowWhenSenderIsNotPresent() {
        fillChainblockWithTransactions();
    ...
    public void testGetByReceiverOrderShouldReturnCorrectReceiverWithCorrectOrder() {
        ...
        for (int i = 0; i < 10; i++) {
            TransactionImpl transaction = new TransactionImpl(100 + i,
                    TransactionStatus.SUCCESSFUL, "from", receiver, 1000 + 10 * i);
